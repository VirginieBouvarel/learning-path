...
- phase cible : phase 3
- élément retiré ou allégé : installation explicite de `PrimeVue` et fabrication des premiers composants Vue métier sur cette base
...
- forme attendue : étape complète centrée sur l'installation, le cadrage d'usage et l'intégration de composants métier réels dans l'UI avec `PrimeVue`
- reprise effective : phase 3, étapes 2 à 4
...
- raison du report : la nouvelle phase 2 reste centrée sur l'architecture front, les types, les mappers, les use cases et la réécriture du flux de données ; la dette CSS devient vraiment structurante au moment de construire les composants UI avec `PrimeVue`
...
- reprise effective : phase 3, étape 6
...
- reprise effective : phase 3, étape 5
